...
class Producto
{
    ...
    public function cargarFormulario($request)
    {
        ...
        $this->descripcion = isset($request["txtDescripcion"]) ? strip_tags($request["txtDescripcion"]) : "";
        $this->imagen = isset($request["txtImagen"]) ? $request["txtImagen"] : "";
        $this->fk_idtipoproducto = isset($request["lstTipoProducto"]) ? $request["lstTipoProducto"] : "0";
    }
