...
class Venta
{
    ...
    public function cargarFormulario($request)
    {
        ...
        $this->fk_idcliente = isset($request["lstCliente"]) ? $request["lstCliente"] : "0";
        $this->fk_idproducto = isset($request["lstProducto"]) ? $request["lstProducto"] : "0";
        $this->fecha = isset($request["txtFecha"]) ? $request["txtFecha"] . " " . $request["txtHora"] : "";
        $this->cantidad = isset($request["txtCantidad"]) ? strip_tags($request["txtCantidad"]) : 0;
