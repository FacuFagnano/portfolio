                ...
                <div class="p-5">
                  ...
                  <form action method="POST" class="user">
                    ...
                    <div class="form-group">
                      <input type="text" class="form-control form-control-user" name="txtUsuario" id="txtUsuario" value="facufagnano" placeholder="Usuario">
                    </div>
                    <div class="form-group">
                      <input type="password" class="form-control form-control-user" name="txtClave" id="txtClave" value="admin123" placeholder="Contraseña">
                    </div>
                    <div class="form-group">
                  ...
                  <div class="text-center">
                    <a class="small" href="register.php">¡Creá una cuenta!</a>
                  </div>
                </div>
              </div>
            </div>
